...
class PickProjectIssuesPage extends React.Component {
    generateItem = (pid, name, uid, iid, idE) => {
        let hrf = "/issues/"+uid+"/"+pid
        return (
    ...
    render(){
        return(
            <div>
                ...
                <UserProjectsLayout headerTitle={"Which Project's Issues do you want to see?"} uid ={this.props.uid}
...
export default PickProjectIssuesPage